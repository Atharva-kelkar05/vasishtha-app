...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    ...
    userStream = vashishthaBackupFirebaseUserStream()
      ..listen((user) {
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      ...
      'ExpertSection': ExpertSectionWidget(),
      'GeminiChatPage': GeminiChatPageWidget(),
    };
