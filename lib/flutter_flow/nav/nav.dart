...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          asyncParams: {
            'selectedDocRefID': getDoc(['doctors'], DoctorsRecord.fromSnapshot),
          },
          builder: (context, params) => PaymentPageWidget(
            ...
            selectedDocRefID: params.getParam(
              'selectedDocRefID',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          ...
          asyncParams: {
            'userNoteDoc': getDoc(
                ['users', 'userJournal'], UserJournalRecord.fromSnapshot),
          },
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'JournalPage')
              : NavBarPage(
                  initialPage: 'JournalPage',
                  page: JournalPageWidget(
                    userNoteDoc: params.getParam(
                      'userNoteDoc',
                      ParamType.Document,
                    ),
                  ),
        ...
        FFRoute(
          name: CreateJournalPageWidget.routeName,
          path: CreateJournalPageWidget.routePath,
          asyncParams: {
            'userNoteDoc': getDoc(
                ['users', 'userJournal'], UserJournalRecord.fromSnapshot),
          },
          builder: (context, params) => CreateJournalPageWidget(
            userNoteDoc: params.getParam(
              'userNoteDoc',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: EditJournalPageWidget.routeName,
          path: EditJournalPageWidget.routePath,
          asyncParams: {
            'userNoteDoc': getDoc(
                ['users', 'userJournal'], UserJournalRecord.fromSnapshot),
          },
          builder: (context, params) => EditJournalPageWidget(
            userNoteDoc: params.getParam(
              'userNoteDoc',
              ParamType.Document,
            ),
        ...
        FFRoute(
          name: ExpertSectionWidget.routeName,
          path: ExpertSectionWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'ExpertSection')
              : NavBarPage(
                  initialPage: 'ExpertSection',
                  page: ExpertSectionWidget(),
                ),
        ),
        FFRoute(
          name: GeminiChatPageWidget.routeName,
          path: GeminiChatPageWidget.routePath,
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'GeminiChatPage')
              : NavBarPage(
                  initialPage: 'GeminiChatPage',
                  page: GeminiChatPageWidget(),
                ),
        )
